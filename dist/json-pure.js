...
var API = function API (socket) {
  this.socket = socket;
};

API.prototype.create = function create (dataType, requestMap) {
  this.socket.sendObj({
    action_str: 'create',
    data_type: dataType,
...
API.prototype.retrieve = function retrieve (dataType, requestMap) {
  this.socket.sendObj({
    action_str: 'retrieve',
    data_type: dataType,
    request_map: requestMap
...
API.prototype.update = function update (dataType, requestMap) {
  this.socket.sendObj({
    action_str: 'update',
    data_type: dataType,
    request_map: requestMap
...
API.prototype.delete = function delete$1 (dataType, requestMap) {
  this.socket.sendObj({
    action_str: 'delete',
    data_type: dataType,
    request_map: requestMap
...
API.prototype.flush = function flush (dataType, requestMap) {
  this.socket.sendObj({
    action_str: 'flush',
    data_type: dataType,
    request_map: requestMap
...
var install = function (Vue, options) {
  ...
  Vue.mixin({
    ...
    methods: {
      websocketOnMessage: function websocketOnMessage (event) {
...
var handleJsonPure = function (event, data) {
